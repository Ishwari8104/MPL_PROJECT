  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        color: Colors.white,
        borderRadius: widget.index == 0 || widget.index % 3 == 0 ? BorderRadius.only(
        ...
        children: [
          Padding(
            ...
            child: ClipRRect(
              ...
              child: Image.asset('assets/images/${categoriesGrid[widget.index].imageUrl}',
              height: 80,
              width: 80,
              fit: BoxFit.cover,
              ),
          ...
          Column(
            ...
            children: [
              Text(categoriesGrid[widget.index].name,
              style:TextStyle(
                color: Colors.indigo,
              ...
              SizedBox(height: 10),
              Text(categoriesGrid[widget.index].price,
              style:TextStyle(
